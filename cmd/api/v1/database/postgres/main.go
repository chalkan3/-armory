...
import (
	...
	"scheduler/internal/api/v1/database/postgres"
	nodelistner "scheduler/internal/schedule/v1/listners/postgres"
...
var eventListeners = scheduler.Listeners{
	"create-postgres": nodelistner.Postgres,
}

func main() {
	fs := flag.NewFlagSet("", flag.ExitOnError)
	var (
		httpPort    = fs.String("http_port", "9010", "application http port default 9000")
	...
	routes := postgres.NewHTTPServer(postgres.NewService(repository, scheduler), logger)
